...
def T_ssy(w, shapes, params, arrays):
    ...
    w = jnp.expand_dims(w, [0, 1, 2, 3])

    state_numbers = { 'n_h_λ'     : 0,
                      'n_h_c'     : 1,
                      'n_h_z'     : 2,
                      'n_z'       : 3,
                      'jn_h_λ'    : 4,
...
def test_vectorized_equals_loops(shapes=(4, 7, 6, 5)):
    """
